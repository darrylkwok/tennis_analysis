...
class BallTracker:
    ...
    def interpolate_ball_positions(self, ball_positions):
        ...
        ball_positions = [{1: x} for x in df_ball_positions.to_numpy().tolist()] # Return back a list of dictionaries, track_id : bounding box
    ...
    def detect_frame(self, frame):
        # Here we are using Yolov5 - yolov5 does not do tracking
        # Since there is only 1 ball, we do not need to track. We can just predict the ball in every frame
    ...
    def draw_bboxes(self, video_frames, player_detections):
        ...
        for frame, ball_dict in zip(video_frames, player_detections):
            ...
            for track_id, bbox in ball_dict.items():
                ...
                cv2.rectangle(frame, (int(x1), int(y1)), (int(x2), int(y2)), (0, 255, 255), 2) # only the borders, not filled
